  ...
  <div class="page-container">
    ...
    <div class="search-form">
      <el-form :inline="true" :model="searchForm">
        <el-form-item label="关键词">
          <el-input v-model="searchForm.keyword" placeholder="电影名称" clearable />
        </el-form-item>
    ...
    <div class="table-container">
      <el-table :data="tableData" stripe v-loading="loading">
        ...
        <el-table-column prop="title" label="电影名称" min-width="150">
          <template #default="{ row }">
            <div class="movie-info">
              <el-image :src="row.poster" class="movie-poster" fit="cover" />
              <span>{{ row.title }}</span>
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="categoryNames" label="分类" width="120" />
